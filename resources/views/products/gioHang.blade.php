                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-12 col-md-3 col-lg-2 col-xm-9 ">
                            <div class="sanPhamm">
                                <div class="hinhAnh" style="background-image: url('images/7.jpg');">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-12 col-md-4 col-lg-7 col-xm-9 ">
                            <div class="gioiThieu">
                                <div class="ml-0">
                                    <span class="tenSP"><strong>Máy bay trực thăng di chuyển phát nhạc</strong>
                                    </span>
                                    <br>
                                    <span class="soLuongSP">Chỉ còn 15 sản phẩm</span>
                                    <br>
                                    <span class="nguonSP">Cung cấp bới: <a href="#">ToyKid</a> </span>
                                    <br>

                                    <a href="#"> <button class="btn btn-outline-primary btn-sm" type="button">Bỏ
                                            chọn</button></a>
                                    <br>
                                </div>
                            </div>
                    ...
                    <div class="row">
                            <div class="col-xs-6 col-sm-12 col-md-3 col-lg-2 col-xm-9 ">
                                <div class="sanPhamm">
                                    <div
                                        class="hinhAnh" style="background-image: url('images/7.jpg');">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-12 col-md-4 col-lg-7 col-xm-9 ">
